...
<body>
	...
	<div class="container shadow bg-light mx-auto mt-5 p-5">
		...
		<a herf="order_status.jsp?status=2">[입금완료]</a>
		<a herf="order_status.jsp?status=3">[배송중]</a>
		<a herf="order_status.jsp?status=4">[배송완료]</a>
		</div>
		<table class="table table-striped table-hover">
			...
			<%
			ArrayList<OrderDTO> orders = (new OrderDAO()).getList("입금전", "");
			...
			<tbody>
				<tr>
					...
					<td><a href="orderd_delivery.jsp?bid=<%=order.getOid()%>"><%=order.getOstatus()%>[발송]</a></td>
