...
public class ReplyDAO {
	...
	public ArrayList<ReplyDTO> getList(String bid) throws NamingException, SQLException {
	...
	public boolean insert(String bid, String uid, String content) throws NamingException, SQLException {
		Connection conn = null;
		PreparedStatement pstmt = null;
		try {
			uid = "test";
