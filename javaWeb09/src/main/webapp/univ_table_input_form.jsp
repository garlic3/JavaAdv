...
<div class = "container shadow mx-auto mt-5 p-5 w-75" style="background-color:#77d998;">
<div class="alert alert-success" role="alert" style="text-align:center;">학생 정보 입력
</div>
...
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="여자">
  <label class="form-check-label" for="inlineRadio1">여자</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="남자">
  ...
  <div class="col-12 text-center">
    <button type="submit" class="btn btn-light">학생 등록</button>
  </div>
</form>
</div>
